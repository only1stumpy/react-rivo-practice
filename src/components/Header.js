            ...
            <div className='header-nav'>
                ...
                {isDropdownOpen && (
                  <div className={`dropdown-content ${isDropdownOpen ? 'show' : ''}`}>
                    ...
                    <a href='/exterprise' className='navItem'>Retail & Ecommerce</a>
                    <a href='/exterprise' className='navItem'>Real Estate</a>
                    <a href='/exterprise' className='navItem'>Custom CRM</a>
                    <a href='/exterprise' className='navItem'>Education & E-Learning</a>
                    <a href='/exterprise' className='navItem'>Food & Restaurant</a>
                    <a href='/exterprise' className='navItem'>Retail & E-Commerce</a>
                    <a href='/exterprise' className='navItem'>Logistic & Distribution</a>
                  </div>
                )}
              </div>
                <a href ="#contacts-section" className='navItem'>Contacts</a>
                <a href ="/career" className='navItem'>Careers</a>
                <a href ="/order" className='orderItem'>Make order<img src={arrow} alt='arrow' className='orderArrow'/></a>
                <a href="/" onClick={handleMenuOpen} className='menuItem'><img src={menu} alt='arrow'/>Menu</a>
                {isMenuOpen &&
      ...
      <div className='menu'>
        ...
        <div className='menu-items'>
          <div className='menu-nav'>
            ...
            <a href='/career' onClick={handleMenuOpen}><h1 className='menu-item-nav'>career</h1></a>
            <a href='/blog' onClick={handleMenuOpen}><h1 className='menu-item-nav'>blog</h1></a>
